...
import google.registry.tools.javascrap.RecreateBillingRecurrencesForDomainsCommand;
...
public final class RegistryTool {
  ...
  public static final ImmutableMap<String, Class<? extends Command>> COMMAND_MAP =
      new ImmutableMap.Builder<String, Class<? extends Command>>()
          ...
          .put(
              "recreate_billing_recurrences_for_domains",
              RecreateBillingRecurrencesForDomainsCommand.class)
