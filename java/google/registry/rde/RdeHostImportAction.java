...
public class RdeHostImportAction implements Runnable {
   ...
   */
  private RdeHostInput createInput() {
    return new RdeHostInput(mapShards, importBucketName, importFileName);
  }

  /**
   * Creates a new {@link RdeHostImportMapper}
   */
  private RdeHostImportMapper createMapper() {
    return new RdeHostImportMapper(importBucketName);
  }
