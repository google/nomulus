 ...
 *
 * <p>A user is an "admin" if it has the admin permission, or if their email is in the "Support" G
 * Suite group.
 *
 ...
 * defined, or (b) the user is logged out, or (c) the user is an admin, or (d) bypassAdminCheck is
 * true.
 */
@Immutable
public class AuthenticatedRegistrarAccessor {
  ...
  /**
   * Whether this user is an admin, meaning either they have the admin permission or a member of the
   * Support G Suite group.
   */
