...
class NordnVerifyActionTest {
  ...
  void beforeEach() throws Exception {
    ...
    action.url = new URL("http://ry.marksdb.org/blobio");
  }
  ...
  void testSuccess_sendHttpRequest_urlIsCorrect() throws Exception {
    action.run();
    assertThat(httpUrlConnection.getURL()).isEqualTo(new URL("http://ry.marksdb.org/blobio"));
  }
  ...
  void testFailure_badUrl() throws Exception {
    action.url = new URL("http://example.com/blobio");
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> action.run());
    assertThat(thrown).hasMessageThat().contains("Bad URL");
  }
