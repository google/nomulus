...
public class ConsoleDUMDownloadAction extends ConsoleApiAction {
  ...
  private static final String SQL_TEMPLATE =
      """
          SELECT CONCAT(d.domain_name, ',', d.creation_time, ',', d.registration_expiration_time, ',', d.statuses)
  ...
  protected void getHandler(User user) {
    ...
    consoleApiParams
        .response()
        .setDateHeader(
            "Expires", DateTime.now().withTimeAtStartOfDay().plusDays(1).withTimeAtStartOfDay());
