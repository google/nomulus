  ...
  void setUp() {
    ...
    domain =
        new Domain.Builder()
            ...
            .setLastTransferTime((Instant) fakeClock.now())
            ...
            .setRegistrationExpirationTime(DateTimeUtils.plusYears(fakeClock.now(), 1))
            .setAuthInfo(DomainAuthInfo.create(PasswordAuth.create("password")))
            .setDsData(ImmutableSet.of(DomainDsData.create(1, 2, 3, new byte[] {0, 1, 2})))
            .setLaunchNotice(
                LaunchNotice.create(
                    "tcnid", "validatorId", (Instant) START_INSTANT, (Instant) START_INSTANT))
            .setSmdId("smdid")
            .addGracePeriod(
                GracePeriod.create(
