...
public class RdeHostInputTest {
  ...
  private static final ByteSource DEPOSIT_1000_HOST = RdeTestData.get("deposit_1000_host_header.xml");
  private static final ByteSource DEPOSIT_10000_HOST = RdeTestData.get("deposit_10000_host_header.xml");
   ...
   *
   * @param numberOfHosts Number of hosts in the escrow file
