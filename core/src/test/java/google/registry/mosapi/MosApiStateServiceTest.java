...
class MosApiStateServiceTest {
  ...
  void testGetServiceStateSummary_downStatus_filtersActiveIncidents() throws Exception {
    ...
    ServiceStatus dnsService =
        new ServiceStatus("Down", 50.0, ImmutableList.of(dnsIncident));
    ...
    TldServiceState rawState =
        new TldServiceState(
            ...
            12345L,
            "Down",
            ImmutableMap.of("DNS", dnsService, "RDAP", rdapService));
  ...
  void testGetServiceStateSummary_throwsException_whenClientFails() throws Exception {
    when(client.getTldServiceState("tld1"))
        .thenThrow(new MosApiException("Network error", null));
  ...
  void testGetAllServiceStateSummaries_partialFailure_returnsErrorState() throws Exception {
    ...
    when(client.getTldServiceState("tld2"))
        .thenThrow(new MosApiException("Failure", null));
