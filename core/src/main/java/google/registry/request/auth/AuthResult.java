...
public record AuthResult(
  ...
  private static AuthResult create(
      AuthLevel authLevel, @Nullable User user, @Nullable String serviceEmailAccount) {
    checkArgument(
        user == null || serviceEmailAccount == null,
    ...
    checkArgument(
        authLevel != APP || serviceEmailAccount != null,
        "Service account email must be specified for auth level APP");
    return new AuthResult(
        authLevel, Optional.ofNullable(user), Optional.ofNullable(serviceEmailAccount));
  }
