...
/**
 * JUnit Rule to provision {@link JpaTransactionManager} backed by {@link PostgreSQLContainer}.
 *
 * <p>This rule also replaces the {@link JpaTransactionManager} provided by {@link
 * TransactionManagerFactory} with the {@link JpaTransactionManager} generated by the rule itself,
 * so that all SQL queries will be sent to the database instance created by {@link
...
public class JpaTransactionManagerRule extends ExternalResource {
  ...
  private TransactionManager cachedTm;
  ...
  public void before() {
    ...
    JpaTransactionManager txnManager = new JpaTransactionManager(emf, clock);
  ...
  /** Returns the {@link FakeClock} used by the underlying {@link JpaTransactionManager}. */
