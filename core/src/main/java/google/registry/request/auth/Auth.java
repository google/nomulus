...
public enum Auth {
   ...
   * They are all behind IAP and only accounts allowlisted by IAP can access them. They then check
   * if the user actually has access to the specific endpoint using {@link
