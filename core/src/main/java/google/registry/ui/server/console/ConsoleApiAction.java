...
public abstract class ConsoleApiAction implements Runnable {
  ...
  private Map<String, Object> expandRegistrarWithContacts(
    ...
    Set.of("passwordHash", "salt") // Set of fields to remove from final diff
        .stream()
