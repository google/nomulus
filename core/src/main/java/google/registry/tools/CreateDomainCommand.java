...
final class CreateDomainCommand extends CreateOrUpdateDomainCommand {
  ...
  protected void initMutatingEppToolCommand() {
    ...
    for (String domain : domains) {
      ...
      addEppInput(
          clientId,
          EppInputs.createDomain(domain, password)
              .setPeriod(period, Period.Unit.YEARS)
              .setNameservers(ImmutableSet.copyOf(nameservers))
              .addExtension(EppExtensions.feeCreate(currency, cost))
              .addExtension(
              ...
              .addExtension(EppExtensions.allocationToken(allocationToken))
              .build());
    }
  }
}
