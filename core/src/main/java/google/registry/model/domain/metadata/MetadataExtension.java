...
public class MetadataExtension extends ImmutableObject implements CommandExtension {
  ...
  public static class Builder {
    private final MetadataExtension instance = new MetadataExtension();
    ...
    public Builder setRequestedByRegistrar(Boolean requestedByRegistrar) {
      instance.requestedByRegistrar = requestedByRegistrar;
      return this;
    }

    public Builder setAnchorTenant(Boolean isAnchorTenant) {
      instance.isAnchorTenant = isAnchorTenant;
      return this;
    }

    public MetadataExtension build() {
      return instance;
    }
  }
}
