    ...
    return pipeline.apply(
        ...
        RegistryJpaIO.read(
                ...
                ImmutableMap.of(
                    ...
                    startTime,
                    "oneYearAgo",
                    DateTimeUtils.minusYears(endTime, 1)),
                true,
                (Long id) -> {
          ...
          ImmutableSet.copyOf(
              billingRecurrence
                  ...
                  .getInstancesInRangeInstant(
                      Range.closedOpen(
                          latestOf(
                              DateTimeUtils.plusYears(
                                  billingRecurrence.getRecurrenceLastExpansionInstant(), 1),
                              startTime),
                                ...
                                () -> {
                                  Instant currentCursorTime =
                                      tm().loadByKeyIfPresent(
                                          ...
                                          .orElse(
                                              Cursor.createGlobal(
                                                  RECURRING_BILLING, toDateTime(START_INSTANT)))
                                  ...
                                  tm().put(
                                          Cursor.createGlobal(
                                              RECURRING_BILLING, toDateTime(endTime)));
                                });
                      }
                    }))
            .getPipeline());
