...
public enum Auth {
   ...
   * They are all behind IAP and only accounts allowlisted by IAP can access them. They check if the
   * user actually has access to the specific console using {@link AuthenticatedRegistrarAccessor}.
   */
