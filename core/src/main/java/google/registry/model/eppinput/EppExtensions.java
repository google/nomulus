...
public class EppExtensions {
   ...
   * @param isAnchorTenant whether the domain is an anchor tenant (optional)
   */
  @Nullable
  ...
  /** Returns a fee create extension for a single fee (V12). */
  @Nullable
  ...
  /** Returns a fee create extension for a single fee (V06). */
  @Nullable
  ...
  /** Returns a fee create extension for a single fee without a type (simple cost, V12). */
  @Nullable
