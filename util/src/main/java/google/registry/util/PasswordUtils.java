...
public final class PasswordUtils {
  ...
  /**
   * Password hashing algorithm that takes a password and a salt (both as {@link byte[]} and returns
   * a hash.
   */
  public enum HashAlgorithm {
    ...
    /**
     * Memory-hard hashing algorithm, perferred over SHA-256.
     *
  ...
  /**
   * Verifies a password by regerating the hash with the provided salt and comparing it to the
   * provided hash.
   *
   ...
   *
   * @return the {@link HashAlgorithm} used to verify the password, or {@code null} if neither
   *     works.
   */
