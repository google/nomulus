...
public final class RegistrarConsoleModule {
  ...
  @Provides
  @Parameter("createdBeforeTime")
  public static Optional<DateTime> provideCreatedBeforeTime(HttpServletRequest req) {
    return extractOptionalParameter(req, "createdBeforeTime").map(DateTime::parse);
  }
