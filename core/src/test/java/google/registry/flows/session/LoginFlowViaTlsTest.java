...
public class LoginFlowViaTlsTest extends LoginFlowTestCase {
  ...
  private static final String GOOD_CERT_HASH = CertificateSamples.SAMPLE_CERT_HASH;
  private static final String GOOD_CERT = CertificateSamples.SAMPLE_CERT;
  private static final String BAD_CERT_HASH = CertificateSamples.SAMPLE_CERT2_HASH;
  private static final String BAD_CERT = CertificateSamples.SAMPLE_CERT2;
