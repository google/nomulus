...
public final class DomainLockUtilsTest {
  ...
  void testFailure_applyUnlock_supersededByInterleavedUnlockAndLock() {
    ...
    clock.advanceOneMilli();
    domainLockUtils.verifyVerificationCode(unlockB.getVerificationCode(), true);
    ...
    // 5. Lock C applied
    clock.advanceOneMilli();
    domainLockUtils.verifyVerificationCode(lockC.getVerificationCode(), true);
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class,
            () -> domainLockUtils.verifyVerificationCode(unlockA.getVerificationCode(), true));
    assertThat(thrown)
        .hasMessageThat()
        .isEqualTo(
