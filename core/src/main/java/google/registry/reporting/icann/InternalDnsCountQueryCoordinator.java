 ...
 */
public class InternalDnsCountQueryCoordinator extends DnsCountQueryCoordinator {
  ...
  public void prepareForQuery(YearMonth yearMonth) throws InterruptedException {
    ...
    logger.atInfo().log("projectId: %s", projectId);
    logger.atInfo().log("dnsCountProjectId: %s", dnsCountProjectId);
    logger.atInfo().log("icannReportingDataSet: %s", icannReportingDataSet);
