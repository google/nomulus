...
public class RdeContactInputTest {
  ...
  private static final ByteSource DEPOSIT_0_CONTACT = RdeTestData.get("deposit_0_contact_header.xml");
  private static final ByteSource DEPOSIT_1_CONTACT = RdeTestData.get("deposit_1_contact.xml");
  private static final ByteSource DEPOSIT_199_CONTACT = RdeTestData.get("deposit_199_contact_header.xml");
  private static final ByteSource DEPOSIT_200_CONTACT = RdeTestData.get("deposit_200_contact_header.xml");
  private static final ByteSource DEPOSIT_1000_CONTACT = RdeTestData.get("deposit_1000_contact_header.xml");
  private static final ByteSource DEPOSIT_10000_CONTACT = RdeTestData.get("deposit_10000_contact_header.xml");
   ...
   *
   * @param numberOfContacts Number of contacts in the escrow file
