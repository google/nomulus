...
@Embeddable
@MappedSuperclass
public class AbstractUser extends UpdateAutoTimestampEntity implements Buildable {
  ...
  /** Setter method for use only by Hibernate. */
  ...
  @Override
  public Builder<? extends AbstractUser, ?> asBuilder() {
    return new Builder<>(clone(this));
  }

  /** Builder for constructing immutable {@link AbstractUser} objects. */
  public static class Builder<T extends AbstractUser, B extends Builder<T, B>>
