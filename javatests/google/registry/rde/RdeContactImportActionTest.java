...
public class RdeContactImportActionTest extends MapreduceTestCase<RdeContactImportAction> {
  ...
  private Optional<Integer> mapShards = Optional.absent();

  private RdeContactImportAction action;
  ...
  private void checkContact(ContactResource contact) {
    assertThat(contact.getContactId()).isEqualTo("love-id");
    assertThat(contact.getRepoId()).isEqualTo("2-ROID");
  }
