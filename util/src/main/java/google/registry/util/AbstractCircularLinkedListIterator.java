...
/**
 * Immutable class that support circular iteration through a group of elements of type {@param <T>}.
 *
...
public abstract class AbstractCircularLinkedListIterator<T> implements Iterator<T> {
  ...
  /**
   * Node class for {@link AbstractCircularLinkedListIterator} that stores value of element
  ...
  /**
   * As {@link AbstractCircularLinkedListIterator} is an immutable class, it needs
   ...
   */
  public abstract static class Builder<T, B extends Builder<T, B, L>, L extends AbstractCircularLinkedListIterator> {
