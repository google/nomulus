    ...
    Domain domain =
        persistDomainWithPendingTransfer(
            persistDomainWithDependentResources(
                "domain",
                "tld",
                toDateTime(now.minus(5, java.time.temporal.ChronoUnit.DAYS)),
                toDateTime(now.minus(5, java.time.temporal.ChronoUnit.DAYS)),
                toDateTime(plusYears(now, 2))),
            toDateTime(now.minus(4, java.time.temporal.ChronoUnit.DAYS)),
            toDateTime(now.minus(1, java.time.temporal.ChronoUnit.DAYS)),
            toDateTime(plusYears(now, 2)));
