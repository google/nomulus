...
public final class ResourceTransferUtils {
  ...
  public static PendingActionNotificationResponse createPendingTransferNotificationResponse(
    ...
    return createPendingTransferNotificationResponse(
        ...
        transferRequestTrid,
        actionResult,
        google.registry.util.DateTimeUtils.toInstant(processedDate));
  }
  ...
  public static void handlePendingTransferOnDelete(
    ...
    handlePendingTransferOnDelete(
        domain, newDomain, google.registry.util.DateTimeUtils.toInstant(now), historyEntry);
  }
        ...
        .setTransferData(
            domain
                ...
                .setPendingTransferExpirationTime(
                    google.registry.util.DateTimeUtils.toDateTime(checkNotNull(now)))
                .build());
  }
  ...
  public static Domain approvePendingTransfer(
    ...
    return builder
        .setLastTransferTime(google.registry.util.DateTimeUtils.toDateTime(now))
  ...
  public static Domain approvePendingTransfer(
    ...
    return approvePendingTransfer(
        domain, transferStatus, google.registry.util.DateTimeUtils.toInstant(now));
  }
  ...
  public static Domain denyPendingTransfer(
    ...
    return resolvePendingTransfer(domain, transferStatus, now)
        .setLastEppUpdateTime(google.registry.util.DateTimeUtils.toDateTime(now))
