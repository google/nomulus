...
public class EppInputs {
  ...
  public static class DomainUpdateBuilder extends FluentEppInputBuilder<DomainUpdateBuilder> {
    ...
    private final DomainCommand.Update.AddRemove.Builder addBuilder =
        new DomainCommand.Update.AddRemove.Builder();
    private final DomainCommand.Update.AddRemove.Builder removeBuilder =
        new DomainCommand.Update.AddRemove.Builder();
    ...
    public DomainUpdateBuilder addNameservers(ImmutableSet<String> nameservers) {
      addBuilder.setNameserverHostNames(nameservers);
      return this;
    }
    ...
    public DomainUpdateBuilder removeStatuses(ImmutableSet<StatusValue> statuses) {
      removeBuilder.setStatusValues(statuses);
      return this;
    }
    ...
    public DomainUpdateBuilder setAutorenews(@Nullable Boolean autorenews) {
      if (autorenews != null) {
        addExtension(DomainUpdateSuperuserExtension.create(autorenews));
      }
      return this;
    }
    ...
    @Override
    protected EppInput.InnerCommand getCommand() {
      DomainCommand.Update.AddRemove add = addBuilder.build();
      DomainCommand.Update.AddRemove remove = removeBuilder.build();
      if (!add.isEmpty()) {
        builder.setInnerAdd(add);
      }
      if (!remove.isEmpty()) {
        builder.setInnerRemove(remove);
      }
