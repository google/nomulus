        ...
        next: (result: DomainData) => {
          ...
          this.dialog.open(ResponseDialogComponent, {
            data: {
              ...
              content: `Successfully deleted - ${successCount} domain(s)<br/>Failed to delete - ${failureCount} domain(s)<br/>Some domains could not be deleted due to ongoing processes or server errors. Please check the table for more information.`,
            },
          });
          this.selection.clear();
