...
class DomainCheckFlowTest extends ResourceCheckFlowTestCase<DomainCheckFlow, Domain> {
  ...
  /* package */ static ReservedList createReservedList() {
    persistResource(
  ...
  /* package */ static AllocationToken setUpDefaultToken() {
    return setUpDefaultToken("TheRegistrar");
  }

  /* package */ static AllocationToken setUpDefaultToken(String registrarId) {
    AllocationToken defaultToken =
        persistResource(
            new AllocationToken.Builder()
                .setToken("bbbbb")
