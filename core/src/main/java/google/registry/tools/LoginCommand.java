      ...
      app =
          new AuthorizationCodeInstalledApp(
              ...
              url -> {
                ...
                System.out.printf(
                    """
                        Please first run the following command in a separate terminal on your local host:
                ...
                System.out.printf(
                    """
                        Please then open the following URL in your local browser and follow the instructions:
