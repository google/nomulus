...
class RegistrarsActionTest {
  ...
  @Test
  void testSuccess_getRegistrarIds() throws IOException {
  ...
  @Test
  void testFailure_getRegistrarIds() throws IOException {
    RegistrarsAction action =
        createAction(
            AuthResult.create(
                AuthLevel.USER,
  ...
  @Test
  void testSuccess_onlyLiveRegistrars() throws IOException {
  ...
  private RegistrarsAction createAction(AuthResult authResult) throws IOException {
