  ...
  void setup(Pipeline pipeline) {
    pipeline
        .apply(
            ...
            // is
            // set by EPP flows (even though it is nullalbe in the SQL schema). Therefore, checking
            // if it's null is one way to avoid processing contact history entities that have been
            // processed previously. Refer to RFC 5733 for more information.
            RegistryJpaIO.read(
