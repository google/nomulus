...
public final class BsaLabelUtils {
  ...
  static final CacheLoader<VKey<? extends BsaLabel>, BsaLabel> CACHE_LOADER =
      new CacheLoader<VKey<? extends BsaLabel>, BsaLabel>() {

        @Override
        public BsaLabel load(VKey<? extends BsaLabel> key) {
          return replicaTm().reTransact(() -> replicaTm().loadByKeyIfPresent(key)).orElse(null);
        }

        @Override
        public Map<VKey<? extends BsaLabel>, BsaLabel> loadAll(
            Iterable<? extends VKey<? extends BsaLabel>> keys) {
   ...
   */
  private static LoadingCache<VKey<? extends BsaLabel>, BsaLabel> cacheBsaLabels =
      createBsaLabelsCache(getEppResourceCachingDuration());

  private static LoadingCache<VKey<? extends BsaLabel>, BsaLabel> createBsaLabelsCache(
      Duration expiry) {
  ...
  public static boolean isLabelBlocked(String domainLabel) {
    return cacheBsaLabels.get(BsaLabel.vKey(domainLabel)) != null;
  }
}
