...
public class ClaimsListSqlDaoTest {
  ...
  void save_insertsClaimsListSuccessfully() {
    ...
    ClaimsListShard insertedClaimsList = ClaimsListSqlDao.get();
  ...
  void getCurrent_returnsEmptyListIfTableIsEmpty() {
    assertThat(ClaimsListSqlDao.get().getLabelsToKeys()).isEmpty();
  }
  ...
  void getCurrent_returnsLatestClaims() {
    ...
    assertClaimsListEquals(newClaimsList, ClaimsListSqlDao.get());
  }
