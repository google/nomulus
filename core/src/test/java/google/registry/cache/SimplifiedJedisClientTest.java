...
public class SimplifiedJedisClientTest {
  ...
  void testClient_roundTrip_domain() {
    ...
    assertAboutImmutableObjects()
        .that(client.get("Domain__example.tld"))
  ...
  void testClient_roundTrip_host() {
    ...
    assertThat(client.get("Host__ns1.example.tld")).isEqualTo(host);
  }
  ...
  void testClient_nonexistent() {
    ...
    assertThat(domainClient.get("Domain__nonexistent.tld")).isNull();
    assertThat(hostClient.get("Host__ns1.nonexistent.tld")).isNull();
  }
