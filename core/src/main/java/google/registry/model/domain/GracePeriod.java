...
public class GracePeriod extends GracePeriodBase {
  ...
  private static GracePeriod createInternal(
    ...
    checkArgument(
        (billingEventRecurrence != null) == GracePeriodStatus.AUTO_RENEW.equals(type),
        "Recurrences must be present on (and only on) autorenew grace periods");
    ...
    instance.billingEventRecurrence = billingEventRecurrence;
    return instance;
  }
  ...
  public static GracePeriod createFromHistory(GracePeriodHistory history) {
    return createInternal(
        ...
        history.billingEventRecurrence,
  ...
  public static class GracePeriodHistory extends GracePeriodBase {
    ...
    static GracePeriodHistory createFrom(long historyRevisionId, GracePeriod gracePeriod) {
      ...
      instance.billingEventRecurrence = gracePeriod.billingEventRecurrence;
      return instance;
    }
  }
}
