...
class DomainCheckFlowTest extends ResourceCheckFlowTestCase<DomainCheckFlow, Domain> {
        ...
        new AllocationToken.Builder()
            ...
            .setTokenStatusTransitionsInstant(
                ImmutableSortedMap.<Instant, TokenStatus>naturalOrder()
                    ...
                    .put(clock.now().minus(Duration.ofDays(1)), TokenStatus.VALID)
                    .put(clock.now().plus(Duration.ofDays(1)), TokenStatus.ENDED)
                    .build())
            .build());
    doCheckTest(
        create(false, "example1.tld", "Alloc token invalid for domain"),
    ...
    persistResource(
        new AllocationToken.Builder()
            ...
            .setTokenStatusTransitionsInstant(
                ImmutableSortedMap.<Instant, TokenStatus>naturalOrder()
                    .put(START_INSTANT, TokenStatus.NOT_STARTED)
                    .put(clock.now().minus(Duration.ofDays(2)), TokenStatus.VALID)
                    .put(clock.now().minus(Duration.ofDays(1)), TokenStatus.ENDED)
                    .build())
            .build());
    doCheckTest(
    ...
    persistResource(
        new AllocationToken.Builder()
            ...
            .setTokenStatusTransitionsInstant(
                ImmutableSortedMap.<Instant, TokenStatus>naturalOrder()
                    .put(START_INSTANT, TokenStatus.NOT_STARTED)
                    .put(clock.now().plus(Duration.ofDays(1)), TokenStatus.VALID)
                    .put(clock.now().plus(Duration.ofDays(60)), TokenStatus.ENDED)
                    .build())
            .build());
    setEppInput("domain_check_allocationtoken_fee_stdv1.xml");
    doCheckTest(
  ...
  void testSuccess_oneExistsButWasDeleted() throws Exception {
    persistDeletedDomain("example1.tld", toDateTime(clock.now().minus(Duration.ofDays(1))));
    doCheckTest(
        create(true, "example1.tld", null),
        create(true, "example2.tld", null),
        create(true, "example3.tld", null));
        ...
        setUpDefaultToken("NewRegistrar")
            ...
            .setTokenStatusTransitionsInstant(
                ImmutableSortedMap.of(
                    ...
                    clock.now().plus(Duration.ofDays(1)),
                    TokenStatus.VALID))
            .build());
        ...
        Tld.get("example")
            ...
            .setEapFeeScheduleInstant(
                new ImmutableSortedMap.Builder<Instant, Money>(Ordering.natural())
                    ...
                    .put(clock.now().minus(Duration.ofDays(1)), Money.of(USD, 100))
                    .put(clock.now().plus(Duration.ofDays(1)), Money.of(USD, 50))
                    .put(clock.now().plus(Duration.ofDays(2)), Money.of(USD, 0))
                    .build())
            .build());
  ...
  void testFeeExtension_premium_eap_v06_withRenewalOnRestore() throws Exception {
    ...
    persistResource(
        persistActiveDomain("rich.example")
            .asBuilder()
            .setDeletionTime(clock.now().plus(Duration.ofDays(25)))
            .setRegistrationExpirationTime(clock.now().minus(Duration.ofDays(1)))
    ...
    persistResource(
        Tld.get("example")
            ...
            .setEapFeeScheduleInstant(
                new ImmutableSortedMap.Builder<Instant, Money>(Ordering.natural())
                    .put(START_INSTANT, Money.of(USD, 0))
                    .put(startTime.minus(Duration.ofDays(1)), Money.of(USD, 100))
                    .put(startTime.plus(Duration.ofDays(1)), Money.of(USD, 50))
                    .put(startTime.plus(Duration.ofDays(2)), Money.of(USD, 0))
                    .build())
            .build());
