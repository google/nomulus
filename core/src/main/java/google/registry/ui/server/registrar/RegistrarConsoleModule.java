...
public final class RegistrarConsoleModule {
  ...
  public static Optional<ImmutableSet<RegistrarPoc>> provideContacts(
      HttpServletRequest req, Gson gson) {
    Optional<String> maybeContactsJson = extractOptionalParameter(req, "contacts");
    if (!maybeContactsJson.isPresent()) {
      return Optional.ofNullable(null);
    }
    return Optional.of(
        ImmutableSet.copyOf(gson.fromJson(maybeContactsJson.get(), RegistrarPoc[].class)));
  }
