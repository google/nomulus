...
class ConsoleUsersActionTest {
  ...
  void testSuccess_registrarAccess() throws IOException {
    ...
    assertThat(response.getPayload())
        .isEqualTo(
            "[{\"email_address\":\"test1@test.com\",\"role\":\"PRIMARY_CONTACT\"},{\"email_address\":\"test2@test.com\",\"role\":\"PRIMARY_CONTACT\"}]");
  }
  ...
  void testSuccess_createsUser() throws IOException {
    ...
    assertThat(response.getPayload())
        .contains(
            "{\"password\":\"abcdefghijklmnop\",\"email_address\":\"email-1@email.com\",\"role\":\"ACCOUNT_MANAGER\"}");
  }
