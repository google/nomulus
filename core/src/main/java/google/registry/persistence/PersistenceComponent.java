...
import google.registry.model.transaction.TransactionManagerModule;
...
public interface PersistenceComponent {
  @AppEngineTM
  DatabaseTransactionManager appEngineDatabaseTransactionManager();

  DatastoreTransactionManager datastoreTransactionManager();

  ClaimsListDao claimsListDao();
}
