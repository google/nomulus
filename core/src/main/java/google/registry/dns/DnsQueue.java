...
public class DnsQueue {
  ...
  protected TaskHandle addHostRefreshTask(String hostName) {
  ...
  protected TaskHandle addDomainRefreshTask(String domainName) {
  ...
  protected TaskHandle addDomainRefreshTask(String domainName, Duration countdown) {
    return addToQueue(
        TargetType.DOMAIN,
        domainName,
  ...
  protected TaskHandle addZoneRefreshTask(String zoneName) {
