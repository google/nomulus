...
class DownloadSchedulerTest {
  ...
  static final Duration DOWNLOAD_INTERVAL = org.joda.time.Duration.standardMinutes(30);
  static final Duration MAX_NOP_INTERVAL = org.joda.time.Duration.standardDays(1);
