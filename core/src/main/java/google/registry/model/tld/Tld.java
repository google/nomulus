...
public class Tld extends ImmutableObject implements Buildable, UnsafeSerializable {
   ...
   */
  @Type(value = DurationUserType.class)
  ...
  @Column(nullable = false)
  @Type(value = TldStateTransitionUserType.class)
  ...
  @Column(nullable = false)
  @Type(value = BillingCostTransitionUserType.class)
  ...
  @AttributeOverride(
      name = "amount",
      // Override Hibernate6 default (numeric(38,2)) to match real schema definition (numeric(38,2).
   ...
   */
  @Type(value = AllocationTokenVkeyListUserType.class)
  ...
  // @Type(value = IdnTableEnumSetUserType.class)
  @Enumerated(EnumType.STRING)
