...
public final class DatabaseHelper {
  ...
  public static ImmutableList<PollMessage> getPollMessages(
      String registrarId, java.time.Instant beforeOrAt) {
    return tm().transact(
            () ->
                tm().loadAllOf(PollMessage.class).stream()
                    .filter(pollMessage -> pollMessage.getRegistrarId().equals(registrarId))
  ...
  public static ImmutableList<PollMessage> getPollMessages(
      EppResource resource, String registrarId, java.time.Instant now) {
    return tm().transact(
            () ->
                tm().loadAllOf(PollMessage.class).stream()
                    .filter(
  ...
  public static PollMessage getOnlyPollMessage(String registrarId, java.time.Instant now) {
  ...
  public static PollMessage getOnlyPollMessage(
      String registrarId, java.time.Instant now, Class<? extends PollMessage> subType) {
