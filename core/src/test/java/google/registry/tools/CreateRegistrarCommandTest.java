...
class CreateRegistrarCommandTest extends CommandTestCase<CreateRegistrarCommand> {
  ...
  void testSuccess() throws Exception {
    ...
    assertThat(registrar.getCreationTime()).isIn(Range.closed(toInstant(before), toInstant(after)));
    assertThat(registrar.getLastUpdateTime()).isEqualTo(toDateTime(registrar.getCreationTime()));
