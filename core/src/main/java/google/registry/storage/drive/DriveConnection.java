...
public class DriveConnection {
   ...
   */
  public String createFolder(String title, @Nullable String parentFolderId) throws IOException {
    return drive
        .files()
        .create(createFileReference(title, GOOGLE_FOLDER, parentFolderId))
        .execute()
        .getId();
  }
  ...
  public String createOrUpdateFile(
    ...
    return existingFiles.isEmpty()
        ...
        : updateFile(existingFiles.getFirst(), title, mimeType, bytes);
  }
