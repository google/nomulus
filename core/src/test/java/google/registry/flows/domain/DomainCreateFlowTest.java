        ...
        Tld.get("example")
            ...
            .setEapFeeScheduleInstant(
                ImmutableSortedMap.of(
                    START_INSTANT,
                    Money.of(USD, 0),
                    clock.now().minus(java.time.Duration.ofDays(1)),
                    Money.of(USD, 100),
        ...
        Tld.get("tld")
            ...
            .setTldStateTransitionsInstant(
                new ImmutableSortedMap.Builder<Instant, TldState>(Ordering.natural())
                    .put(google.registry.util.DateTimeUtils.START_INSTANT, PREDELEGATION)
        ...
        Tld.get("tld")
            ...
            .setEapFeeScheduleInstant(
                ImmutableSortedMap.of(
                    ...
                    clock.now().plus(java.time.Duration.ofDays(1)),
                    Money.of(USD, 10),
                    clock.now().plus(java.time.Duration.ofDays(2)),
                    Money.of(USD, 0)))
            .build());
        ...
        Tld.get("tld")
            ...
            .setEapFeeScheduleInstant(
                ImmutableSortedMap.of(
                    START_INSTANT,
                    Money.of(USD, 0),
                    clock.now().minus(java.time.Duration.ofDays(2)),
                    Money.of(USD, 100),
                    clock.now().minus(java.time.Duration.ofDays(1)),
                    Money.of(USD, 0)))
            .build());
