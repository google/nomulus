...
import google.registry.flows.domain.DomainFlowUtils.RegistrantsProhibitedException;
        ...
        DatabaseHelper.newDomain(getUniqueIdFromCommand())
            ...
            .setContacts(
                ImmutableSet.of(
                    ...
                    DesignatedContact.create(Type.TECH, sh8013Contact.createVKey())))
            .build());
    RegistrantsProhibitedException thrown =
        assertThrows(RegistrantsProhibitedException.class, this::runFlow);
    assertAboutEppExceptions().that(thrown).marshalsToXml();
  }
