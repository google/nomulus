...
public class PendingDepositCheckerTest {
  ...
  void testMethod_firstRdeDeposit_initializesCursorToMidnightToday() {
    ...
    assertThat(loadByKey(Cursor.createScopedVKey(RDE_STAGING, registry)).getCursorTimeInstant())
  ...
  void testMethod_subsequentRdeDeposit_doesntMutateCursor() {
    ...
    assertThat(cursor.getCursorTimeInstant()).isEqualTo(yesterday);
  }
  ...
  private static void setCursor(
      final Tld registry, final CursorType cursorType, final Instant value) {
