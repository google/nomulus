...
class ChildEntityInputTest {
  ...
  private void setupResources() {
    ...
    domainHistoryEntryA =
        persistResource(
            new DomainHistory.Builder().setParent(domainA).setModificationTime(now).build());
    contactHistoryEntry =
        persistResource(
            new ContactHistory.Builder().setParent(contact).setModificationTime(now).build());
    oneTimeA =
        persistResource(
  ...
  private void setupSecondDomainBases() {
    ...
    domainHistoryEntryB =
        persistResource(
            new DomainHistory.Builder().setParent(domainB).setModificationTime(now).build());
    oneTimeB =
        persistResource(
            new BillingEvent.OneTime.Builder()
                .setParent(domainHistoryEntryA)
