...
CREATE TABLE public."Registrar" (
    ...
    url text,
    whois_server text,
    last_expiring_cert_notification_sent_date timestamp with time zone NOT NULL,
    last_expiring_failover_cert_notification_sent_date timestamp with time zone NOT NULL
);
