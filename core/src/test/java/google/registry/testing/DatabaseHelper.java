...
public class DatabaseHelper {
  ...
  private static void initializeObject(Object object) {
    // We must initialize all possible collection fields in this object if we wish to
    // use them outside of the transaction. Use reflection to initialize all fields
    // for all objects.
