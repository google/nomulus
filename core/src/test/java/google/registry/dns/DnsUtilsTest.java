...
public class DnsUtilsTest {
  ...
  void testFailure_hostRefresh_unmanagedHost() {
    String unmangedHostName = "ns1.another.example";
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> dnsUtils.requestHostDnsRefresh(unmangedHostName));
    verify(dnsQueue, times(0)).addHostRefreshTask(anyString());
    assertThat(loadAllOf(DnsRefreshRequest.class)).isEmpty();
  }

  @Test
  void testFailure_domainRefresh_unmanagedHost() {
