...
public class ConsoleUsersAction extends ConsoleApiAction {
  ...
  protected void getHandler(User user) {
    if (user.getUserRoles().hasGlobalPermission(ConsolePermission.MANAGE_USERS)) {
      consoleApiParams.response().setPayload(gson.toJson(getAllUsers()));
  ...
  private void runInTransaction(User user) throws IOException {
    ...
    User.Builder builder =
        new User.Builder()
            .setUserRoles(userRolesBuilder)
            .setEmailAddress(newUser.getPrimaryEmail());
