...
import static google.registry.model.common.Cursor.getCursorTimeOrStartOfTimeInstant;
...
public final class RdeUploadAction implements Runnable, EscrowTask {
  ...
  @Override
  public void runWithLock(final Instant watermark) throws Exception {
    ...
    Instant stagingCursorTime = getCursorTimeOrStartOfTimeInstant(cursor);
